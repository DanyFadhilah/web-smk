                            ...
                            <div class="form-group">
                                <label for="nis">NIS <span class="text-danger">*</span></label>
                                    <select name="nis" id="nis" class="form-control" required>
                                        <option value="{{ old('nis') ?? $ekskul->nis }}">{{ old('nis') ?? $ekskul->nis }}</option>   
                            ...
                            <div class="form-group">
                                <label for="siswa">Nama Siswa <span class="text-danger">*</span></label>
                                    <select name="siswa" id="siswa" class="form-control" required>
                                        <option value="{{ old('siswa') ?? $ekskul->siswa }}">{{ old('siswa') ?? $ekskul->siswa }}</option>   
                                        @foreach ($siswa as $item)
                            ...
                            <div class="form-group">
                                <label for="kelas">Kelas <span class="text-danger">*</span></label>
                                    <select name="kelas" id="kelas" class="form-control" required>
                                        <option value="{{ old('kelas') ?? $ekskul->kelas }}">{{ old('kelas') ?? $ekskul->kelas }}</option>   
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="kegiatan">kegiatan <span class="text-danger">*</span></label>
                                    <input type="text" name="kegiatan" id="kegiatan" class="form-control" required @error('kegiatan') is-invalid @enderror value="{{ old('kegiatan') ?? $ekskul->kegiatan }}" id="kegiatan">
                                    @error('kegiatan')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="keterangan">Keterangan <span class="text-danger">*</span></label>
                                    <input type="text" name="keterangan" id="keterangan" class="form-control" required @error('keterangan') is-invalid @enderror value="{{ old('keterangan') ?? $ekskul->keterangan }}" id="keterangan">
                                    @error('keterangan')
                                    <span class="invalid-feedback" role="alert">
