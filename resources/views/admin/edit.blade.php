                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="nip" type="text" class="form-control @error('nip') is-invalid @enderror" value="{{ old('nip') ?? $admin->nip }}" id="nip" placeholder="Input NIP">
                                @error('nip')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') ?? $admin->nama }}" id="nama" placeholder="Input Nama">
                                @error('nama')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="alamat_1" type="text" class="form-control @error('alamat_1') is-invalid @enderror" value="{{ old('alamat_1') ?? $admin->alamat_1 }}" id="alamat_1" placeholder="Input Alamat 1">
                                @error('alamat_1')
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="alamat_2" type="text" class="form-control @error('alamat_2') is-invalid @enderror" value="{{ old('alamat_2') ?? $admin->alamat_2 }}" id="alamat_2" placeholder="Input Alamat 2">
                                @error('alamat_2')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="provinsi" type="text" class="form-control @error('provinsi') is-invalid @enderror" value="{{ old('provinsi') ?? $admin->provinsi }}" id="provinsi" placeholder="Input Provinsi">
                                @error('provinsi')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="kabkota" type="text" class="form-control @error('kabkota') is-invalid @enderror" value="{{ old('kabkota') ?? $admin->kabkota }}" id="kabkota" placeholder="Input Kota/Kab">
                                @error('kabkota')
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp') ?? $admin->no_hp }}" id="no_hp" placeholder="Input no HP">
                                @error('no_hp')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir') ?? $admin->tempat_lahir }}" id="tempat_lahir" placeholder="Input Tempat Lahir">
                                @error('tempat_lahir')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="tanggal_lahir" type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir') ?? $admin->tanggal_lahir }}">
                                @error('tanggal_lahir')
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') ?? $admin->user->email }}" id="email" placeholder="Input Email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <a href="{{ route('edit.password.admin', $admin->id) }}" class="btn btn-primary w-100">Klik button ini!</a>
                            </div>
                        </div>
                    </div>
