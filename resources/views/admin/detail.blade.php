...
<div class="card shadow mt-4">
	<div class="card-header">
        <div class="row">
            <div class="col-md-10">
                <h3 class="panel-title"><i class="fas fa-user-edit"></i> Deatil Data Admin <i class="fas fa-exchange-alt"></i> {{ $admin->nama }}</h3>
            </div>
        </div>
	</div>
	<div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $admin->nip ?? '' }}" id="nip" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" value="{{ $admin->nama ?? '' }}" id="nama" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="alamat_1">Alamat 1</label>
                                <input type="text" class="form-control" value="{{ $admin->alamat_1 ?? '' }}" id="alamat_1" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $admin->alamat_2 ?? '' }}" id="alamat_2" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="provinsi">Provinsi</label>
                                <input name="provinsi" type="text" class="form-control" value="{{ $admin->provinsi ?? '' }}" id="provinsi" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="kabkota">Kabupaten/Kota</label>
                                <input type="text" class="form-control" value="{{ $admin->kabkota ?? '' }}" id="kabkota" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $admin->no_hp ?? '' }}" id="no_hp" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tempat_lahir">Tempat Lahir</label>
                                <input type="text" class="form-control" value="{{ $admin->tempat_lahir ?? '' }}" id="tempat_lahir" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tanggal_lahir">Tanggal Lahir</label>
                                <input type="date" class="form-control" value="{{ $admin->tanggal_lahir ?? '' }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('/storage/images/profile/'.$admin->profile) }}" class="img-fluid w-100" style="height: 300px; object-fit: cover; object-position: center;"  alt="Foto Profil">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ktp">Foto KTP</label>
                                <img src="{{ asset('/storage/images/ktp/'.$admin->ktp) }}" class="img-fluid w-100"  style="height: 300px; object-fit: cover; object-position: center;" alt="Foto KTP">
                            </div>
                        </div>
                    </div>
            </div>
