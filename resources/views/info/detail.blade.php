    ...
    <li class="nav-item active">
        ...
        <div id="tabInfo" class="collapse" aria-labelledby="headingInfo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="{{ route('add.info') }}">Create</a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $info->judul }}" id="judul" readonly>
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" cols="30" rows="10" class="form-control" readonly>{{ $info->deskripsi }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <iframe src="{{ asset('/storage/lampiran/'.$info->lampiran) }}" class="w-100">
                        Otomatis Mendownload
                    </iframe>
                </div>
            </div>
        </div>
