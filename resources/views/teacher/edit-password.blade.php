...
@section('title') Dashboard | Edit Password Guru @endsection
...
@section('content')
    ...
    <a href="{{ route('view.detail.teacher', $teacher->id) }}" class="btn btn-primary w-20">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mt-4">
                ...
                <div class="card-body">
                    <form action="{{ route('update.password.teacher', $teacher->id) }}" method="POST">
                        @csrf
                        <div class="row">
