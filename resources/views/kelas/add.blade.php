                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="kode_jurusan" id="kelas" class="form-control">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="kelas" type="text" class="form-control @error('kelas') is-invalid @enderror" value="{{ old('kelas') }}" id="kelas" placeholder="Input Kelas">
                                @error('kelas')
                                    <span class="invalid-feedback" role="alert">
