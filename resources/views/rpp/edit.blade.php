                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="semester">No <span class="text-danger">*</span></label>
                                    <input type="text" name="no" id="no" class="form-control" required @error('no') is-invalid @enderror value="{{ old('no') ?? $rpp->no }}" id="no">                                    
                                    @error('no')
                            ...
                            <div class="form-group">
                                <label for="nik">NIK <span class="text-danger">*</span></label>
                                    <select name="nik" id="nik" class="form-control" required>
                                        <option value="{{ old('nik') ?? $rpp->nik }}">{{ old('nik') ?? $rpp->nik }}</option>   
                                        @foreach ($guru as $gu)
                            ...
                            <div class="form-group">
                                <label for="guru">Nama Guru <span class="text-danger">*</span></label>
                                    <select name="guru" id="guru" class="form-control" required>
                                        <option value="{{ old('guru') ?? $rpp->guru }}">{{ old('guru') ?? $rpp->guru }}</option>      
                                        @foreach ($guru as $gu)
                            ...
                            <div class="form-group">
                                <label for="mapel">Mata Pelajaran <span class="text-danger">*</span></label>
                                    <select name="mapel" id="mapel" class="form-control" required>
                                        <option value="{{ old('mapel') ?? $rpp->mapel }}">{{ old('mapel') ?? $rpp->mapel }}</option>      
                            ...
                            <div class="form-group">
                                <label for="ki">KI <span class="text-danger">*</span></label>
                                    <select name="ki" id="ki" class="form-control" required>
                                        <option value="{{ old('ki') ?? $rpp->ki }}">{{ old('ki') ?? $rpp->ki }}</option>      
                            ...
                            <div class="form-group">
                                <label for="kd">KD <span class="text-danger">*</span></label>
                                    <select name="kd" id="kd" class="form-control" required>
                                        <option value="{{ old('kd') ?? $rpp->kd }}">{{ old('kd') ?? $rpp->kd }}</option>      
