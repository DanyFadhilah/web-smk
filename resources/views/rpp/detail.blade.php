	...
	<div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $rpp->no }}" id="no" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $rpp->nik }}" id="nik" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Dokumen</label>
                    <iframe src="{{ asset('/storage/lampiran/'.$rpp->lampiran) }}" class="w-100">
