    ...
    <div class="col-md-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <p class="card-text">Pilih data Admin yang akan di tambhakan dan pastikan urutannya benar lalu upload.</p>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="diterima_dikelas" type="text" class="form-control @error('diterima_dikelas') is-invalid @enderror" value="{{ old('diterima_dikelas') }}" id="diterima_dikelas" placeholder="Input Diterima di Kelas">
