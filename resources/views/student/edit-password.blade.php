...
@section('title') Dashboard | Edit Password Siswa @endsection
...
@section('content')
    ...
    <a href="{{ route('view.detail.student', $student->id) }}" class="btn btn-primary w-20">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mt-4">
                ...
                <div class="card-body">
                    <form action="{{ route('update.password.student', $student->id) }}" method="POST">
                        @csrf
                        <div class="row">
